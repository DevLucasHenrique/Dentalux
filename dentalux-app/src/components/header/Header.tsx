      ...
      <header>
        <nav id="pc-nav">
          ...
          <div className="pc-nav">
            <Link className="pc-link" to={"/"}>Home</Link>
            <Link className="pc-link" to={"/"}>Serviços</Link>
            <Link className="pc-link" to={"/"}>Clínicas</Link>
          </div>
          <button className="pc-services">Ver especialidades</button>
        </nav>
        <nav id="mobile-nav">
          <img src={logoMobile} className="logo-mobile" alt="Logo" />
          <div className="end-nav">
            ...
            <button
              className={`mobile-menu-button ${menuButtonState}`}
              onClick={() => setMenu()}
            >
